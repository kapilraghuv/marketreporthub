                                        ...
                                        <div className="rbt-dashboard-content bg-color-white rbt-shadow-box">
                                            <div className="content">
                                                <div className="section-title">
                                                    <h4 className="rbt-title-style-3">Report List
                                                    </h4>
                                                </div>
                                                    ...
                                                    <div className="rbt-dashboard-table table-responsive mobile-table-750 mt--30">
                                                        <table className="rbt-table table table-borderless">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <th>
                                                                        Electrostatic discharge (ESD) Protection Devices Market Size
                                                                    </th>

                                                                    <td>
                                                                        <p className="b3">Healthcare & Pharmaceutical</p>
                                                                    </td>
                                                                    <td>
                                                                        <p className="b3">Upcoming</p>
                                                                    </td>
                                                                    <td>
                                                                    <img src="https://marketreporthub.com/admin/product/107-08-2022_07:23:56Chemicals%20and%20Materials%20(1).jpg" style={{ height: "50px" }} />
                                                                    </td>
                                                                    <td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                    <img src="https://marketreporthub.com/admin/product/107-08-2022_07:23:56Chemicals%20and%20Materials%20(1).jpg"
                                                                        style={{height:"50px"}} />
                                                                    </td>
                                                                    <td>
